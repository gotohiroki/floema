...
export default class {
  ...
  onTouchMove({ x, y }) {
    const xDisatance = x.start - x.end
    const yDisatance = x.start - x.end

    this.x.target = this.scrollCurrent.x - xDisatance,
    this.y.target = this.scrollCurrent.y - yDisatance
  }
